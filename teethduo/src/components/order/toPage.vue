        ...
        <div class='userMsg' >
          <a class="mint-cell mint-field">
            <div class="mint-cell-wrapper">
              <div class="mint-cell-title"><span class="mint-cell-text">保单号</span></div> 
              <div class="mint-cell-value">
                <input placeholder="请输入保单号"  type="text" class="mint-field-core phone policy"   v-model.trim="inputNo"> 
    ...
    methods: {
      ...
      toPage:function(){
        ...
        response.then(function(res){
          ...
          if(res.status == 200){
            var url = (config.baseURL).replace('call/','insurance/orderIndex?param=');
//          _this.urlStr = url + str;// 拼接跳转路径
            _this.urlStr = config_param.base_path+'/webApp/insurance/orderIndex?param='+ str;// 拼接跳转路径
