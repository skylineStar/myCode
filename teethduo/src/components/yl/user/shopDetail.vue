...
//	        	window.location.replace("#/common/errorPage");//跳转至错误页面
      ...
      goOrder:function(){
      	sessionStorage.removeItem('mapRouter');
//	      window.location.href = "/common/toMapEmpty#/common/enterRouter?page="+encodeURIComponent("order/toOrder")
	      window.location.href = "ylOrder.html#/common/enterRouter?page=yl/order/toOrder"
	  },
