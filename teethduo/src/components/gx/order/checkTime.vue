...
//        this.anios();
    ...
    methods: {
      ...
      fillDate: function () {
        ...
        if(this.curMon==12){
          var nextday = this.nextYear+"-"+(this.nextMon)+'-01';
        }else{
...
//          window.location.replace('gxOrder.html#/gx/order/toOrder')
//          window.location.href = "#/common/enterRouter?page="+encodeURIComponent("order/toOrder")
//          window.location.href = "#/common/enterRouter?page=gxOrder.html#/gx/order/toOrder";
