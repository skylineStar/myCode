...
//          window.location.replace("#/common/errorPage");
          ...
          if(str.lon) {
            setTimeout(()=> {
           		this.$router.push({path: '/common/enterRouter?page=gx/order/toOrder'});
            	
           		//this.$router.push({path: '/common/enterRouter', query: {page: "gxOrder.html#/gx/order/toOrder"}});
              //window.location.href = "#/common/enterRouter?page=gx/order/toOrder";
            }, 100)
          }
        }
...
//          window.location.replace("#/common/errorPage");
          ...
          if(str) {
            setTimeout(function() {
              window.location.href = "gxUser.html#/gx/user/shopDetail"}, 100)
          }
        }
      },
      // 调取地图
