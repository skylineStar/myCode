						...
						parResult.then(function(res){
							...
							if(data.status=="1"){
								...
								setTimeout(function(){
									...
									window.location.href='#/common/enterRouter?page='+encodeURIComponent('gx/order/toOrder&orderId=')+orderIds+'&policyNo='+that.policyNo+'&channelType='+channelType+'&cpnTicketNo='+cpnTicketNo+'&wesurePolicyNo='+wesurePolicyNo},1000)
							}else{
								Toast (data.message);
							}
						})
